...
namespace BethanysPieShop.Areas.Admin.Controllers
{
    ...
    public class PieController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("PieId,,Name,ShortDescription,LongDescription,Price,ImageUrl,ImageThumbnailUrl,IsPieOfTheWeek,InStock,CategoryId,Category")] Pie pie)
        {
            if (id != pie.PieId)
            {
                return NotFound();
