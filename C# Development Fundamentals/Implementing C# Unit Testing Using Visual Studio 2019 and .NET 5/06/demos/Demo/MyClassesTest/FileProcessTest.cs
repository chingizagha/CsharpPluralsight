...
namespace MyClassesTest
{
  ...
  public class FileProcessTest : TestBase
  {
    ...
    [TestMethod]
    [DataRow(1, 1, DisplayName = "AreNumbersEqual")]
    [DataRow(42, 42, DisplayName = "AreNumbersEqual")]
    ...
    [DataRow(@"C:\Windows\Regedit.exe", DisplayName = "FileNameUsingDataRow")]
    [DataRow("FileToDeploy.txt", DisplayName = "FileNameUsingDataRow")]
