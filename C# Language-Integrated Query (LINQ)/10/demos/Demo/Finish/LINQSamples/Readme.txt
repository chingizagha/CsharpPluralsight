...
AggregateUsingGrouping() - Group products by Size property and calculate min/max/average prices
AggregateUsingGroupingMoreEfficient() - Use an accumulator class to be more efficient